...
from .scene import Scene, Offset
...
class Castle:
    def __init__(self, map_view: MapView, color, scene, castle_config):
        ...
        self.castle_image = [pygame.image.load(IMAGES_DIR / "castle1.png"),
                             pygame.image.load(IMAGES_DIR / "castle2.png"),
                             pygame.image.load(IMAGES_DIR / "castle3.png"),
                             pygame.image.load(IMAGES_DIR / "castle4.png")]
