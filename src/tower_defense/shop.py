...
from .paths import IMAGES_DIR, FONTS_DIR
        ...
        self.items = {
            ItemType.STONE:
                Item(ItemType.STONE, True, towers_config["stone"]["price"], Point(1020, 250),
                     pygame.image.load(IMAGES_DIR / "stone_tower/stone_turret0.png").convert_alpha()),
            ItemType.METEOR:
                Item(ItemType.METEOR, True, towers_config["meteor"]["price"], Point(1160, 250),
                     pygame.image.load(IMAGES_DIR / "meteor_tower/meteor_turret0.png").convert_alpha()),
            ItemType.FIRE:
                Item(ItemType.FIRE, False, towers_config["fire"]["price"], Point(1105, 250),
                     pygame.image.load(IMAGES_DIR / "bomb_01.png").convert_alpha())}

        self.text_font = pygame.font.Font(FONTS_DIR / "MotionControl-Bold.otf", 40)
        self.tower_shop = pygame.image.load(IMAGES_DIR / "tower-32x40.png").convert()
        self.bomb_shop = pygame.image.load(IMAGES_DIR / "bomb_01.png").convert()
        self.coin = pygame.image.load(IMAGES_DIR / "coin.png").convert_alpha()
        self.player = player
