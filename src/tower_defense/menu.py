...
from .paths import AUDIO_DIR, FONTS_DIR, IMAGES_DIR
...
class MenuTile:
    def __init__(self, number, menu, screen, x, y, size, text_font, col, row):
        ...
        self.menu = menu
        self.number = number
        self.image = pygame.image.load(IMAGES_DIR / "brick-80x80.png").convert()
...
class ExitButton:
    ...
    def __init__(self, x, y):
        self.image = pygame.image.load(IMAGES_DIR / "Exit_button.png").convert()
        self.rect = pygame.Rect(x, y, self.image.get_width(), self.image.get_height())
...
class Menu:
    def __init__(self, screen):
        ...
        self.text_font = pygame.font.Font(FONTS_DIR / "MotionControl-Bold.otf", 50)
        self.text_font_project = pygame.font.Font(FONTS_DIR / "DAGGERSQUARE.otf", 22)
        self.logo = pygame.image.load(IMAGES_DIR / "Title.png").convert()
