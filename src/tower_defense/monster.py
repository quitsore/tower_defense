...
from .map import Entity, MapView
from .scene import Scene, Offset, Point
from .paths import *
...
class MonsterFactory:
    ...
    def __init__(self, scene: Scene, monsters_config):
        ...
        self.spider_sprites = MonsterFactory.load_sprites(IMAGES_DIR / "spider")
        self.goblin_sprites = MonsterFactory.load_sprites(IMAGES_DIR / "goblin")
        self.orc_sprites = MonsterFactory.load_sprites(IMAGES_DIR / "orc")
